...
<p>В связи с этим удалось достичь уменьшения размеров исполняемых файлов (размеры файлов указаны в файлах <b>IHT2/IHT2/Screenshots/sizeAfterRefact</b> и <b>IHT2/IHT2/Screenshots/sizeBeforeRefact</b>)</p>
